...
var _datepicker = _interopRequireDefault(require("./datepicker.t"));

var _dom = require("../utils/dom");

require("../d-calendar/d-calendar");

require("./d-datepicker.css");
  ...
  _createClass(DatePicker, [{
    ...
    value: function connectedCallback() {
      ...
      if (this.hasAttribute("months")) {
        attrs.push({
          name: "months",
          value: this.getAttribute("months")
        });
      }
      ...
      if (this.hasAttribute("step")) {
        attrs.push({
          name: "step",
          value: this.getAttribute("step")
        });
      }

      this.innerHTML = (0, _datepicker["default"])({
        config: _config["default"],
        contents: contents,
        attrs: attrs
      });
      this.calendar = this.querySelector(_config["default"].calendarComponent);
    ...
    value: function bindings() {
      ...
      this.calendar.addEventListener("change", function () {
        // Populate the input with picked value
        _this2.querySelector(_this2.input).value = _this2.calendar.value;
      });
      (0, _dom.$find)(this.input, this).forEach(function (el) {
        el.addEventListener(_this2.openEvent, function (e) {
          _this2._component.classList.remove("hidden");

          _this2.querySelector(_this2.input).classList.add("d-focused");

          _this2.calendar.updateWidth();
...
customElements.define(_config["default"].datePickerComponent, DatePicker);
